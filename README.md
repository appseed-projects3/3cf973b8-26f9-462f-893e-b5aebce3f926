...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-25 06:26`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3cf973b8-26f9-462f-893e-b5aebce3f926.git
$ cd 3cf973b8-26f9-462f-893e-b5aebce3f926
```
